...
setup(
    ...
    author='IBM Application Development Team, MarkusFraKS',
    author_email='opendev@us.ibm.com',
    maintainer='MarkusFraKS',
    maintainer_email='markus.franke@galeria.de',
    url='https://github.com/MarkusFraKS/python-ibmdbsa',
    download_url='https://github.com/MarkusFraKS/python-ibmdbsa/releases',
