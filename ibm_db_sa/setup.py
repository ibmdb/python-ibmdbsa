...
setup( name    = PACKAGE,
       ...
       data_files   = [ ('', ['./README']),
                        ...
                        ('', ['./LICENSE']) ],
       entry_points = {
         'sqlalchemy.dialects': ['ibmdbsa = ibm_db_sa.base:dialect',
                                 'ibmdbsa.zxjdbc = ibm_db_sa.zxjdbc:dialect',
                                 'ibmdbsa.pyodbc = ibm_db_sa.pyodbc:dialect',
                                 'ibmdbsa.zxjdbc400 = ibm_db_sa.zxjdbc400:dialect',
                                 'ibmdbsa.pyodbc400 = ibm_db_sa.pyodbc400:dialect',
                                 'ibmdbsa_zxjdbc = ibm_db_sa.zxjdbc:dialect',
                                 'ibmdbsa_pyodbc = ibm_db_sa.pyodbc:dialect',
                                 'ibmdbsa_zxjdbc400 = ibm_db_sa.zxjdbc400:dialect',
                                 'ibmdbsa_pyodbc400 = ibm_db_sa.pyodbc400:dialect',]
       },
