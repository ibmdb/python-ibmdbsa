...
from sqlalchemy import text, bindparam, outparam, util
...
class OutParamTest(fixtures.TestBase):
    ...
    def test_out_params(self):
        result = config.db.execute(text('call foo(:x_in, :x_out, :y_out, :z_out)',
                        bindparams=[bindparam('x_in'), outparam('x_out'), outparam('y_out'), outparam('z_out')]),
